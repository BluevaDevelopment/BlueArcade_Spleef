    ...
    public ModuleSetupMetadata getSetupMetadata() {
        return new ModuleSetupMetadata() {
            ...
            public List<ModuleSetupStep> getSetupSteps() {
                return List.of(
                        new ModuleSetupStep("floor", true, "Configure Floor", "Configure the module-specific floor setup data.", List.of("/baa game <arena> spleef floor"), "selection region")
                );
            }
            ...
            public List<ModuleSetupCommand> getSetupCommands() {
                return List.of(
                        new ModuleSetupCommand("floor", "/baa game <arena> spleef floor", "Configure floor setup data.", true)
                );
            }
